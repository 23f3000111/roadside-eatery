  ...
  return (
    <section className="section-pad bg-ink relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-80 h-80 rounded-full bg-accent/12 blur-3xl -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full bg-gold/10 blur-3xl translate-x-1/2 translate-y-1/2" />
        {/* Grid pattern */}
        <div
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 text-center relative z-10">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 border border-accent/30 rounded-full px-4 py-1.5 mb-8">
            <span className="w-2 h-2 rounded-full bg-accent animate-pulse" />
            <span className="font-manrope text-xs text-accent tracking-widest uppercase font-semibold">
          ...
          <h2 className="font-playfair text-4xl md:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6">
            Come Hungry,
            <span className="block italic text-accent">Leave Happy.</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-5">
            ...
            <motion.button
              ...
              className="btn-outline-ember border-white/30 text-white hover:border-accent text-base px-8 py-4"
            >
              See Menu
            </motion.button>
          </div>
